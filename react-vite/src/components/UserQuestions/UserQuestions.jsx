                        ...
                        {userQuestions.length ? (
                            <div>
                                ...
                                {userQuestions.map((question) => (
                                    <div className="user-question-container" key={question.id}>
                                        ...
                                        <div className="user-question-title-tag-container">
                                            <NavLink to={`/questions/${question.id}`} className="user-question-title">
                                                {question.title}
                                            </NavLink>
                                            <div className="user-question-tag-delete-container">
                                                <div className="user-question-tag-container">
                                                    {question.tags.map((tag) => (
                                                        <p className="user-question-tag" key={tag.id}>
                                                            {tag.tag_name}
                                                        </p>
                                                    ))}
                                                </div>
                                                <div>
                                                    <button
                                                        className="user-question-delete-button"
